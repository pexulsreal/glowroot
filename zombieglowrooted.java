...
public class zombieglowrooted<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear_r1 = body.addOrReplaceChild("headwear_r1", CubeListBuilder.create().texOffs(44, 44).addBox(-2.0F, -23.0F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(1.01F)), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition headwear_r2 = left_arm.addOrReplaceChild("headwear_r2", CubeListBuilder.create().texOffs(2, 47).addBox(-2.0F, -24.0F, -8.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(-5.0F, 22.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition headwear_r3 = right_arm.addOrReplaceChild("headwear_r3", CubeListBuilder.create().texOffs(2, 47).addBox(-2.0F, -24.0F, -22.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(19.0F, 22.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.0F, 12.0F, 0.0F));

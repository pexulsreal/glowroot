...
public class Modelbabyglowsquid<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("glowroot", "modelbabyglowsquid"), "main");
	...
	public Modelbabyglowsquid(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tentacle1 = partdefinition.addOrReplaceChild("tentacle1", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, 27.5F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition tentacle2 = partdefinition.addOrReplaceChild("tentacle2", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.75F, 27.5F, 1.75F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition tentacle4 = partdefinition.addOrReplaceChild("tentacle4", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.75F, 27.5F, 1.75F, 0.0F, -0.7854F, 0.0F));
		PartDefinition tentacle5 = partdefinition.addOrReplaceChild("tentacle5", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, 27.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition tentacle6 = partdefinition.addOrReplaceChild("tentacle6", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.75F, 27.5F, -1.75F, 0.0F, -2.3562F, 0.0F));
		PartDefinition tentacle7 = partdefinition.addOrReplaceChild("tentacle7", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 27.5F, -2.5F, 0.0F, -3.1416F, 0.0F));
		PartDefinition tentacle8 = partdefinition.addOrReplaceChild("tentacle8", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.75F, 27.5F, -1.75F, 0.0F, -3.927F, 0.0F));

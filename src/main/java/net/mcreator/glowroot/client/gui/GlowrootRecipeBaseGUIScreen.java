...
import net.mcreator.glowroot.network.GlowrootRecipeBaseGUIButtonMessage;
...
public class GlowrootRecipeBaseGUIScreen extends AbstractContainerScreen<GlowrootRecipeBaseGUIMenu> {
	private final static HashMap<String, Object> guistate = GlowrootRecipeBaseGUIMenu.guistate;
	...
	public GlowrootRecipeBaseGUIScreen(GlowrootRecipeBaseGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("glowroot:textures/screens/glowroot_recipe_base_gui.png");
	...
	public void init() {
		...
		imagebutton_buttonx = new ImageButton(this.leftPos + -136, this.topPos + 6, 20, 18, 0, 0, 18, new ResourceLocation("glowroot:textures/screens/atlas/imagebutton_buttonx.png"), 20, 36, e -> {
			if (true) {
				GlowrootMod.PACKET_HANDLER.sendToServer(new GlowrootRecipeBaseGUIButtonMessage(0, x, y, z));
				GlowrootRecipeBaseGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});

...
public class GHROOMORHALLWAYRenderer extends MobRenderer<GHROOMORHALLWAYEntity, Modelglowroothybridfinal<GHROOMORHALLWAYEntity>> {
	public GHROOMORHALLWAYRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelglowroothybridfinal(context.bakeLayer(Modelglowroothybridfinal.LAYER_LOCATION)), 1.1f);
	}

	@Override
	public ResourceLocation getTextureLocation(GHROOMORHALLWAYEntity entity) {

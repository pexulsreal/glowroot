...
public class GlowrootCattailBlock extends Block implements SimpleWaterloggedBlock {
	...
	public boolean canSurvive(BlockState blockstate, LevelReader worldIn, BlockPos pos) {
		if (worldIn instanceof LevelAccessor world) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			return GlowrootCattailBlockValidPlacementConditionProcedure.execute(world, x, y, z);
		}

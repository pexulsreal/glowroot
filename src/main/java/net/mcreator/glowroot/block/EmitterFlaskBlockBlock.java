...
public class EmitterFlaskBlockBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public EmitterFlaskBlockBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.WARPED_NYLIUM).sound(SoundType.BONE_BLOCK).strength(9f, 10f).lightLevel(s -> 15).requiresCorrectToolForDrops().noOcclusion()

...
public class GlowBulbBlock extends FlowerBlock {
	public GlowBulbBlock() {
		super(() -> MobEffects.GLOWING, 300, BlockBehaviour.Properties.of().mapColor(MapColor.DIAMOND).sound(SoundType.FLOWERING_AZALEA).strength(0.3f, 0f).hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true)
				.lightLevel(s -> 15).noOcclusion().dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}

...
public class GlowWeedsBlock extends FlowerBlock {
	public GlowWeedsBlock() {
		super(() -> MobEffects.GLOWING, 20, BlockBehaviour.Properties.of().mapColor(MapColor.DIAMOND).sound(SoundType.FUNGUS).instabreak().hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 13).noCollission()

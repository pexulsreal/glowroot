...
public class GlowrootFernBlock extends FlowerBlock {
	public GlowrootFernBlock() {
		super(() -> MobEffects.GLOWING, 20, BlockBehaviour.Properties.of().mapColor(MapColor.DIAMOND).sound(SoundType.FUNGUS).instabreak().hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 12).noCollission()

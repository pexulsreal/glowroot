...
public class GlowMushroomBlock extends FlowerBlock {
	public GlowMushroomBlock() {
		super(() -> MobEffects.GLOWING, 300, BlockBehaviour.Properties.of().mapColor(MapColor.DIAMOND).sound(SoundType.FUNGUS).instabreak().hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 13)

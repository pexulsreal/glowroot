...
public class GlowrootAstilbesBlock extends FlowerBlock {
	public GlowrootAstilbesBlock() {
		super(() -> MobEffects.GLOWING, 25, BlockBehaviour.Properties.of().mapColor(MapColor.DIAMOND).sound(SoundType.FUNGUS).instabreak().hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 11).noCollission()

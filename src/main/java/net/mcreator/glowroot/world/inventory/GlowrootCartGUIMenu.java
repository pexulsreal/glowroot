...
public class GlowrootCartGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GlowrootCartGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GlowrootModMenus.GLOWROOT_CART_GUI.get(), id);

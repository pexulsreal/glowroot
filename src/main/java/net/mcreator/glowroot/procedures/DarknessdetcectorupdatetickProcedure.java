...
public class DarknessdetcectorupdatetickProcedure {
		...
		if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).is(BlockTags.create(new ResourceLocation("glowroot:glowrootartificialchargeblock")))
			...
			if (!world.isClientSide()) {
				...
				if (_blockEntity != null)
					_blockEntity.getPersistentData().putDouble("light_lvl", Math.abs(world.getMaxLocalRawBrightness(BlockPos.containing(x, y + 1, z)) - 15));
				if (world instanceof Level _level)

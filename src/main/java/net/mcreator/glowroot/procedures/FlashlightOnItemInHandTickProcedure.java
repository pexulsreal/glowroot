...
public class FlashlightOnItemInHandTickProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getBoolean("flashlighton") == true) {
			if (itemstack.getOrCreateTag().getDouble("damagewait") == 20) {
				{
				...
				itemstack.getOrCreateTag().putDouble("damagewait", 0);
			} else {
				itemstack.getOrCreateTag().putDouble("damagewait", (itemstack.getOrCreateTag().getDouble("damagewait") + 1));
			}

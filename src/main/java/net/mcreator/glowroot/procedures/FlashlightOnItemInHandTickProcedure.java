...
public class FlashlightOnItemInHandTickProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getBoolean("flashlighton") == true) {
			if (!(EnchantmentHelper.getItemEnchantmentLevel(GlowrootModEnchantments.YELLOW_LIGHT.get(), itemstack) != 0) && EnchantmentHelper.getItemEnchantmentLevel(GlowrootModEnchantments.RED_LIGHT.get(), itemstack) != 0) {

...
public class GHONEEntity extends PathfinderMob {
	public GHONEEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GlowrootModEntities.GHONE.get(), world);
	}

	public GHONEEntity(EntityType<GHONEEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 50;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		LabGeneratorHallway1NeighbourBlockChangesProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		LabGeneratorHallway1NeighbourBlockChangesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

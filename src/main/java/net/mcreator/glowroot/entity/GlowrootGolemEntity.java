...
import net.mcreator.glowroot.procedures.GlowrootGolemOnEntityTickUpdateProcedure;
import net.mcreator.glowroot.procedures.GlowrootGolemEntityDiesProcedure;
...
public class GlowrootGolemEntity extends TamableAnimal {
	public GlowrootGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GlowrootModEntities.GLOWROOT_GOLEM.get(), world);
	}

	public GlowrootGolemEntity(EntityType<GlowrootGolemEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1.2f);
		xpReward = 8;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(4, new OwnerHurtTargetGoal(this) {
			...
			public boolean canUse() {
				double x = GlowrootGolemEntity.this.getX();
				double y = GlowrootGolemEntity.this.getY();
				double z = GlowrootGolemEntity.this.getZ();
				Entity entity = GlowrootGolemEntity.this;
				Level world = GlowrootGolemEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		GlowrootGolemEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void baseTick() {
		super.baseTick();
		GlowrootGolemOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GlowrootGolemEntity retval = GlowrootModEntities.GLOWROOT_GOLEM.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(GlowrootModEntities.GLOWROOT_GOLEM.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

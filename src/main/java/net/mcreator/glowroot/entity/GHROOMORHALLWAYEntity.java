...
import net.mcreator.glowroot.procedures.GHROOMProcedure;
...
public class GHROOMORHALLWAYEntity extends Monster {
	...
	public GHROOMORHALLWAYEntity(EntityType<GHROOMORHALLWAYEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 50;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GHROOMProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		GHROOMProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

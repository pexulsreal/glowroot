...
public class GlowrootHybridEntity extends Monster {
	public GlowrootHybridEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GlowrootModEntities.GLOWROOT_HYBRID.get(), world);
	}

	public GlowrootHybridEntity(EntityType<GlowrootHybridEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 50;
		setNoAi(false);

...
public class Modelbabyglowsquid<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "babyglowsquid"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-3.0F, -17.0F, -3.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition tentacle1 = partdefinition
				.addOrReplaceChild("tentacle1",
						CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F,
		...
		PartDefinition tentacle3 = partdefinition.addOrReplaceChild("tentacle3", CubeListBuilder.create().texOffs(24, 0)
				.addBox(-0.5F, -12.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 27.5F, 2.5F));

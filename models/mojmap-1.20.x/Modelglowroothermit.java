...
public class Modelglowroothermit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "glowroothermit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(66, 6)
						.addBox(-7.0F, -2.0F, -7.0F, 14.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(78, 35)
						.addBox(-5.0F, 2.0F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(87, 12)
						.addBox(-5.0F, -4.0F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(1, 45).addBox(0.0F, -7.0F, 4.6F, 0.0F, 6.0F, 12.0F,
		...
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(1, 45).addBox(0.0F, -7.0F, 5.0F, 0.0F, 6.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = head
				.addOrReplaceChild("cube_r7",
						CubeListBuilder.create().texOffs(1, 45).addBox(0.0F, -7.0F, 5.0F, 0.0F, 6.0F, 12.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 1.0F, 5.0F, 2.3562F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = leftfrontleg
				.addOrReplaceChild("cube_r9",
						CubeListBuilder.create().texOffs(1, 41).addBox(0.0F, -6.0F, 3.0F, 0.0F, 6.0F, 16.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = leftbackleg
		...
		PartDefinition cube_r11 = rightbackleg
		...
		PartDefinition cube_r12 = rightfrontleg

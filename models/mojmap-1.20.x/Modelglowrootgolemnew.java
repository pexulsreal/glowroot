...
public class Modelglowrootgolemnew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "glowrootgolemnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(43, 217).addBox(0.5F, -16.0F, -1.0F, 0.0F, 16.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.7648F, -3.6442F, -15.2357F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(43, 217).addBox(1.0F, -16.0F, -1.0F, 0.0F, 16.0F, 16.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(74, 25)
				...
				.addBox(-6.1924F, -7.0355F, -10.6779F, 12.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = head.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(231, 68).addBox(-0.5095F, -0.6389F, -13.65F, 0.0F, 9.0F, 12.0F,
						new CubeDeformation(0.0F)),

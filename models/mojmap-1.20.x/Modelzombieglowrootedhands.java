...
public class Modelzombieglowrootedhands<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "zombieglowrootedhands"), "main");
	...
	public Modelzombieglowrootedhands(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(20, 40)
		...
		PartDefinition headwear_r1 = body.addOrReplaceChild("headwear_r1",
				CubeListBuilder.create().texOffs(44, 44).addBox(-2.0F, -23.0F, -3.0F, 4.0F, 8.0F, 6.0F,
		...
		PartDefinition headwear_r2 = left_arm
				.addOrReplaceChild("headwear_r2",
						CubeListBuilder.create().texOffs(2, 47).addBox(-2.0F, -24.0F, -8.0F, 4.0F, 8.0F, 4.0F,
								new CubeDeformation(0.5F)),
						PartPose.offsetAndRotation(7.0F, 22.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition headwear_r3 = right_arm.addOrReplaceChild("headwear_r3",
				CubeListBuilder.create().texOffs(2, 47).addBox(-2.0F, -24.0F, -22.0F, 4.0F, 8.0F, 4.0F,
						new CubeDeformation(0.5F)),

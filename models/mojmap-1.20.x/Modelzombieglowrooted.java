...
public class Modelzombieglowrooted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "zombieglowrooted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear = head.addOrReplaceChild("headwear", CubeListBuilder.create().texOffs(20, 40).addBox(
		...
		PartDefinition headwear_r2 = left_arm.addOrReplaceChild("headwear_r2",
